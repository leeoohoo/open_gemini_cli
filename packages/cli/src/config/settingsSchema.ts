  ...
  model: {
    ...
    properties: {
      provider: {
        ...
        requiresRestart: true,
        default: 'openai',
        description: 'Model provider to use for requests.',
        showInDialog: false,
      ...
      openai: {
        ...
        properties: {
          apiKey: {
            ...
            default: undefined as string | undefined,
            description:
              'OpenAI API key. Defaults to OPENAI_API_KEY if not set.',
            showInDialog: false,
          },
          baseUrl: {
            type: 'string',
            ...
            default: undefined as string | undefined,
            description:
              'OpenAI base URL (for custom endpoints). Defaults to OPENAI_BASE_URL or https://api.openai.com/v1.',
            showInDialog: false,
          },
          model: {
            type: 'string',
            ...
            default: undefined as string | undefined,
            description:
              'OpenAI model override. Defaults to OPENAI_MODEL if set.',
            showInDialog: false,
          },
          embeddingModel: {
            type: 'string',
            ...
            default: undefined as string | undefined,
            description:
              'OpenAI embedding model. Defaults to OPENAI_EMBEDDING_MODEL if set.',
            showInDialog: false,
          },
          headers: {
            type: 'object',
            ...
            description: 'Additional headers to send with OpenAI requests.',
            showInDialog: false,
            additionalProperties: {
              type: 'string',
            },
          ...
          toolsEnabled: {
            ...
            requiresRestart: true,
            default: true,
            description: 'Enable tool calling for OpenAI requests.',
            showInDialog: false,
          },
          toolChoice: {
            type: 'string',
            ...
            default: 'auto',
            description:
              'Tool choice for OpenAI requests: auto, none, or required.',
            showInDialog: false,
            options: [
  ...
  security: {
    ...
    properties: {
      ...
      auth: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Deprecated authentication settings (no longer used).',
        showInDialog: false,
        ignoreInDocs: true,
        properties: {
          selectedType: {
            ...
            requiresRestart: true,
            default: undefined as string | undefined,
            description: 'Deprecated auth type selection.',
            showInDialog: false,
            ignoreInDocs: true,
          },
          enforcedType: {
            ...
            requiresRestart: true,
            default: undefined as string | undefined,
            description: 'Deprecated auth type enforcement.',
            showInDialog: false,
            ignoreInDocs: true,
          },
          useExternal: {
            ...
            description: 'Deprecated external auth flag.',
            showInDialog: false,
            ignoreInDocs: true,
          },
        },
