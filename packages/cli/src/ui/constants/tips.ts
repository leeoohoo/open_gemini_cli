...
export const INFORMATIVE_TIPS = [
  ...
  'Configure your model provider and API key (settings.json)…',
  'Set a custom OpenAI base URL for private endpoints (settings.json)…',
  ...
  'Review model settings with /model…',
